...
#height x width
x = tf.compat.v1.placeholder('float',[None, 784])	#if second parameter id not consistent with data, tf throws error. If 2nd param is not written, tf loads the data whatever is
