...
from create_sentiment_featuresets import create_featureset_and_labels
import numpy as np
...
#height x width
x = tf.compat.v1.placeholder('float',[None, len(train_x[0])])	#if second parameter id not consistent with data, tf throws error. If 2nd param is not written, tf loads the data whatever is
